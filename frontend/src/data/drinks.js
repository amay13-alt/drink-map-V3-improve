const mockDrinks = [
  {
    ...
    lat: 24.79612, lng: 120.9758, rating: 4.5, color: '#b45309', logo: '/logos/50lan.png',
  ...
  },
  {
    ...
    lat: 24.7965, lng: 120.9762, rating: 4.1, color: '#e2e8f0', logo: '/logos/coco.png',
  ...
  },
  {
    ...
    lat: 24.7968, lng: 120.9759, rating: 4.6, color: '#475569', logo: '/logos/milksha.png',
  ...
  },
  {
    ...
    lat: 24.7955, lng: 120.9752, rating: 3.9, color: '#64748b', logo: '/logos/chingshin.png',
  ...
  },
  {
    ...
    lat: 24.7972, lng: 120.9765, rating: 4.3, color: '#334155', logo: '/logos/morein.png',
    toppings: [{ name: '統一布丁', price: 15, name_en: 'Pudding', standard_name: '布丁' }]
  },
  {
    id: 6, name: '嫩仙草凍奶茶', name_en: 'Grass Jelly Milk Tea', category: '甜品', price: 50, store: '清原芋圓', store_en: 'Chingyuan',
    lat: 24.7948, lng: 120.9748, rating: 4.2, color: '#94a3b8', logo: '/logos/chingyuan.png',
  ...
  },
  {
    ...
    lat: 24.7975, lng: 120.9755, rating: 4.7, color: '#1e293b', logo: '/logos/daming.png',
  ...
  },
  {
    ...
    lat: 24.7960, lng: 120.9745, rating: 4.4, color: '#475569', logo: '/logos/macu.png',
  ...
  },
  {
    ...
    lat: 24.7963, lng: 120.9751, rating: 4.3, color: '#334155', logo: '/logos/kebuke.png',
  ...
  },
  {
    ...
    lat: 24.7958, lng: 120.9769, rating: 4.4, color: '#64748b', logo: '/logos/shangyulin.png',
  ...
  },
  {
    ...
    lat: 24.7963, lng: 120.9751, rating: 4.2, color: '#334155', logo: '/logos/kebuke.png',
  ...
  },
  {
    ...
    lat: 24.7965, lng: 120.9762, rating: 4.3, color: '#e2e8f0', logo: '/logos/coco.png',
